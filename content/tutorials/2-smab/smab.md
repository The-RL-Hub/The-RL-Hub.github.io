...
می‌بینی که این حد پایین نسبت مستقیم با اندازه‌ی gap داره (یعنی gap بیشتر، regret بیشتر) و از اون طرف، نسبت معکوس با شباهت بین banditها.  
اون شباهت هم با Kullback-Leibler divergence سنجیده می‌شه.
