...
که توی مسائل با بعد بالا خیلی بهتر از ETC با 

$$
O(T^{2/3})
$$

هست. بعضی از الگوریتم‌های جدیدتر حتی exploration رو توی کل پروسه ادامه می‌دن یا اجبارش می‌کنن که ماتریس طراحی (design matrix) همیشه خوب condition بمونه، و اینطوری کارایی بهتر می‌گیرن.
